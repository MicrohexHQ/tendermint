...
type AppConnConsensus interface {
	...
	BatchDeliverTxsAsync(tx [][]byte) []*abcicli.ReqRes
...
func (app *appConnConsensus) BatchDeliverTxsAsync(txs [][]byte) []*abcicli.ReqRes {
	return app.appConn.BatchDeliverTxsAsync(txs)
}
