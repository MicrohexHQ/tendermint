...
// Examples
//
// - [Tendermint](https://github.com/danil-lashin/tendermint/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/danil-lashin/tendermint/blob/master/tools/tm-monitor/rpc.go)
package rpc
